...
public void showHelp(CommandSender sender) {
    ...
    Utils.sendMessage(sender, "§b║ §2§oLengbanlist 帮助信息 - 绫华风格 §b║");
    Utils.sendMessage(sender, "§b╠══════════════════════════════════╣");
    Utils.sendMessage(sender, "§2✦ §b/lban list §7- §3查看被封禁的名单，优雅而公正。");
    Utils.sendMessage(sender, "§2✦ §b/lban a §7- §3广播当前封禁人数，让大家知晓规则的重要性。");
    ...
    Utils.sendMessage(sender, "§2✦ §b/lban list-mute §7- §3查看禁言列表，优雅地维护秩序。");
    Utils.sendMessage(sender, "§2✦ §b/lban help §7- §3显示帮助信息，优雅地解决问题。");
    Utils.sendMessage(sender, "§2✦ §b/lban open §7- §3打开可视化操作界面，绫华带你看看优雅的力量！");
    Utils.sendMessage(sender, "§2✦ §b/lban getIP <玩家名> §7- §3查询玩家的 IP 地址，优雅地维护秩序。");
    ...
    Utils.sendMessage(sender, "§2✦ §b/lban check <玩家名/IP> §7- §3检查玩家或IP的封禁状态，优雅而公正。");
    Utils.sendMessage(sender, "§2✦ §b/report <玩家名> <原因> §7- §3优雅地维护秩序，举报不守规矩的行为。");
    Utils.sendMessage(sender, "§7-> §2§l/report accept <举报编号> §7- §3受理举报，优雅地解决问题。");
    Utils.sendMessage(sender, "§7-> §2§l/report close <举报编号> §7- §3关闭举报，秩序已恢复。");
    Utils.sendMessage(sender, "§2✦ §b/kick <玩家名> <原因> §7- §3踢出不守规矩的玩家！");
    Utils.sendMessage(sender, "§2✦ §b/lban info §7- §3查看插件信息，了解当前运行状态，优雅地解决问题。");
    Utils.sendMessage(sender, "§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3重新设置封禁时间，优雅而公正，维护秩序！");
    Utils.sendMessage(sender, "§b╚══════════════════════════════════╝");
