...
public void showHelp(CommandSender sender) {
    ...
    Utils.sendMessage(sender, "§2✦ §b/lban remove <玩家名> §7- §3移除封禁，知错能改善莫大焉！");
    ...
    Utils.sendMessage(sender, "§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3修改封禁时间，效率第一！");
    Utils.sendMessage(sender, "§6§l◆ 查询信息");
    Utils.sendMessage(sender, "§2✦ §b/lban check <玩家名/IP> §7- §3检查封禁状态，刻晴办事效率第一！");
    Utils.sendMessage(sender, "§2✦ §b/lban history <玩家名> §7- §3调出处罚档案，一目了然！");
    Utils.sendMessage(sender, "§7  = §b/history");
    Utils.sendMessage(sender, "§2✦ §b/report <玩家名> <原因> §7- §3发现违规行为？及时举报，刻晴会高效处理！");
