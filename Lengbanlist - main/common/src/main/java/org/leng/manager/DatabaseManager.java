...
public class DatabaseManager {
    ...
    public DatabaseManager(LengbanlistPlatform plugin) {
        this.plugin = plugin;
    }

    public void initialize() throws SQLException {
        String type = plugin.getConfigString("database.type", "sqlite");
        ...
        if ("sqlite".equalsIgnoreCase(type)) {
            mysql = false;
            String fileName = plugin.getConfigString("database.sqlite.file", "lengbanlist.db");
            ...
            mysql = true;
            String host = plugin.getConfigString("database.mysql.host", "localhost");
            int port = plugin.getConfigInt("database.mysql.port", 3306);
            String database = plugin.getConfigString("database.mysql.database", "lengbanlist");
            String username = plugin.getConfigString("database.mysql.username", "root");
            String password = plugin.getConfigString("database.mysql.password", "password");
